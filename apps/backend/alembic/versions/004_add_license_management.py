"""add license management and user licensing
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('license_key_hash', sa.String(length=255), nullable=True))
    op.add_column('users', sa.Column('is_license_active', sa.Boolean(), nullable=False, server_default=sa.true()))
